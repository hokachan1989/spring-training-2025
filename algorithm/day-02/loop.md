...
<summary><strong>実行結果</strong></summary>
...
ループに関する理解を深めるための練習問題です。

#### 問題1: 合計と平均

1から100までの整数の合計と平均を計算するプログラムを作成してください。

#### 問題2: 奇数の合計

1から50までの奇数の合計を計算するプログラムを作成してください。

#### 問題3: カウントダウンタイマー

10から1までカウントダウンし、最後に「発射！」と表示するプログラムを作成してください。

#### 問題4: 約数の列挙

ユーザーから整数を入力として受け取り、その整数のすべての約数を表示するプログラムを作成してください。
